                ...
                {view === "calendar" ? (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-7 gap-2">
                            ...
                            {Array.from({ length: 28 }).map((_, i) => {
                                ...
                                const hasEntry = day < 16 && day % 7 !== 0 && day % 7 !== 6;
                                return (
                                    <div
                                        key={i}
                                        className={cn(
                    ...
                    <div className="space-y-4">
                        <table className="w-full text-left">
                            ...
                            <tbody>
                                {[1, 2, 3, 4, 5].map((i) => (
                                    <tr key={i} className="border-b border-border/20 last:border-0 hover:bg-white/30 transition-colors">
                                        <td className="py-4 text-sm font-medium">Feb {16 - i}, 2026</td>
                                        <td className="py-4 text-sm">
                                            <span className="px-2.5 py-1 rounded-full bg-green-100 text-green-700 text-xs font-bold tracking-tight">PRESENT</span>
                                        </td>
                                        <td className="py-4 text-sm text-muted-foreground">08:00 AM</td>
                                        <td className="py-4 text-sm text-muted-foreground">04:30 PM</td>
                                        <td className="py-4 text-sm font-bold italic">8.5h</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
